...
export const site = {
  ...
  universityWebsite: 'https://cuhk.edu.cn/zh-hans',
  address: '广东省深圳市龙岗区龙翔大道 2001 号道远楼',
  qqGroup: '293037862',
};
...
export const teamIntro = [
  '香港中文大学（深圳）程序设计竞赛队（以下简称“竞赛队”）是代表香港中文大学（深圳）参加国际/国内大学生程序设计竞赛的组织，由数据科学学院方一向教授、马晨昊教授、陈靖邦教授任指导老师，本科生何润元、周莫非任学生队长。竞赛队向全校同学开放加入的机会。本年度，代表大学参赛的队员来自多个学院，横跨四个年级。',
  '竞赛队所参加的大学生程序设计竞赛是培养高端人才的重要途径。国际大学生程序设计竞赛（International Collegiate Programming Contest）是全球最具影响力的大学生计算机竞赛，被誉为计算机软件领域的奥林匹克。自2020年成立以来，竞赛队已三次晋级国际大学生程序设计竞赛（ICPC）全球总决赛。截至2026年5月，竞赛队累计获得金奖38项、银奖37项和铜奖20项，并于2025年夺得中国大学生程序设计竞赛（CCPC）全国女生专场赛冠军，2026年夺得广东省大学生程序设计竞赛冠军。这一系列优异成绩，充分彰显了学校在高水平计算机人才培养体系建设方面的显著成效，也体现了三位教授悉心指导、系统育人的专业能力。',
  '在亮眼的竞赛成绩之外，竞赛队始终坚守育人初心，积极回馈校园与社会。竞赛队通过举办学业辅导讲座、支持基础教育发展以及搭建高水平赛事平台，持续扩大程序设计文化的影响力。在赛事组织方面，竞赛队先后举办了2023至2024年两届港中大（深圳）程序设计竞赛、2025至2026年两届粤港澳大湾区国际编程大赛，并成功承办了2026年ICPC全国邀请赛（深圳）。此次赛事是学校历史上首次举办的ICPC系列赛事，其成功举办标志着学校在计算机学科竞赛组织能力及学术影响力方面再上新台阶，更为广大学子搭建了近距离感受程序设计魅力与价值的高水平平台。此外，竞赛队还积极参与了大学本科生招生，协助附属学校信息学竞赛培训，举办各类编程相关的课程复习讲座，与大湾区其它高校、企业、中小学进行友好互动等。',
...
export const presentationSlides = [
  ...
  },
  {
    ...
    bullets: ['数据科学学院官网：http://sds.cuhk.edu.cn', '招生咨询邮箱：admissions@cuhk.edu.cn'],
  },
];
